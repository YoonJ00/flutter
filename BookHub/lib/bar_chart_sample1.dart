...
// https://github.com/imaNNeoFighT/fl_chart/blob/master/repo_files/documentations/bar_chart.md#sample-1-source-code
// main 에서 BarChartSample1 클래스 호출 후 사용
// yaml에 의존성 추가 fl_chart: ^0.30.0
...
class BarChartSample1State extends State<BarChartSample1> {
  ...
  // 메인 데이터 , 클릭시 내용 출력, 최댓값 20 ( 넘어가면 가능한데 이미지 약간 깨짐? )
